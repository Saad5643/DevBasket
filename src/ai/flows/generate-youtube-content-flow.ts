...
export const GenerateYoutubeContentInputSchema = z.object({
  topic: z.string().describe('The topic or idea for the YouTube video.'),
...
export const GenerateYoutubeContentOutputSchema = z.object({
  ...
  keywords: z.array(z.string()).describe('A list of 5-10 SEO keywords related to the video topic.'),
});
...
Instructions:
1.  **Title**: Create a compelling, clickable, and SEO-friendly title. It should be under 70 characters.
2.  **Description**: Write a detailed and engaging video description. Start with a 2-3 sentence summary. Then, add a "In this video:" section with bullet points or timestamps. Keep it concise but informative.
3.  **Hashtags**: Generate a list of 10-15 relevant hashtags. Mix broad and specific tags. All hashtags must start with #.
4.  **Keywords**: Generate a list of 5-10 important keywords for the YouTube algorithm.
