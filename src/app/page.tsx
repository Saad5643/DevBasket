      ...
      <main className="flex-1">
        <section className="w-full border-b">
          <div className="container flex min-h-[calc(100vh-5rem)] items-center justify-center px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2 animate-fade-in-up" style={{ animationDelay: '0.2s' } as React.CSSProperties}>
              ...
              <div className="flex flex-col justify-center gap-4 pt-4 min-[400px]:flex-row animate-fade-in-up" style={{ animationDelay: '0.4s' } as React.CSSProperties}>
        ...
        <section id="tools" className="w-full bg-muted/40 py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center animate-fade-in-up" style={{ animationDelay: '0.1s' } as React.CSSProperties}>
            ...
            <div className="mx-auto grid grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-8">
              {tools.map((tool, index) => (
                <div key={tool.name} className="animate-fade-in-up" style={{ animationDelay: `${0.2 + index * 0.1}s` } as React.CSSProperties}>
        ...
        <section id="suggest" className="w-full border-t py-12 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 animate-fade-in-up" style={{ animationDelay: '0.3s' } as React.CSSProperties}>
